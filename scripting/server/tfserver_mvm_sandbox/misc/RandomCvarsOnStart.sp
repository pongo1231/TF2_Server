...
public void OnConfigsExecuted()
{
    ...
    TrySetDirectSpecial("tf_bot_melee_only", "1");
    ...
    TrySetWithSMSpecial("sm_kartbots_enabled", "1", true);
    TrySetWithSMSpecial("sm_robotshuman_enabled", "1", true);
    TrySetWithSMSpecial("sm_chargebots_enabled", "1", true);
    TrySetWithSMSpecial("sm_spells_enabled", "1", false);
    TrySetWithSMSpecial("sm_aia_all", "1", false);
    TrySetWithSMSpecial("sm_hugeexplosions_enabled", "1", true);
