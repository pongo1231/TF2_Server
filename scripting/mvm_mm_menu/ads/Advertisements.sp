...
public OnClientPostAdminCheck(int client) {
	...
	Server_PrintToChat(client, "Server", "If you are stuck as an spectator, use /mvmred to join red.");
	Server_PrintToChat(client, "Server", "");
	...
	Server_PrintToChat(client, "Server", "Either join this server through the community server list, leave the server then join by using 'retry' in the console or by just not opening any in-game menu.");
}
